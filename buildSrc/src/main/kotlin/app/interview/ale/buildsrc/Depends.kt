package app.interview.ale.buildsrc
...
object Depends {
    ...
    object Versions {
        ...
        const val multiViewAdapterVersion = "3.0.0"
    ...
    object Libraries {
        ...
        const val multiViewAdapter = "dev.ahamed.mva3:adapter:${Versions.multiViewAdapterVersion}" //v3, which support AndroidX
        const val multiViewAdapter_dataBinding_ext = "dev.ahamed.mva3:ext-databinding:${Versions.multiViewAdapterVersion}"
        const val multiViewAdapter_decoration_ext = "dev.ahamed.mva3:ext-decorator:${Versions.multiViewAdapterVersion}"
        const val multiViewAdapter_diffUtil_ext = "dev.ahamed.mva3:ext-diffutil-rx:${Versions.multiViewAdapterVersion}"
    ...
    object Environments {
        const val debugBaseUrl = "https://apps.uthus.vn/api/api-testing/"
        const val releaseBaseUrl = "https://apps.uthus.vn/api/api-testing/"
    }
