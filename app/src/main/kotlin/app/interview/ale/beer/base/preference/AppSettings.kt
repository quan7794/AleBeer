package app.interview.ale.beer.base.preference
...
object AppSettings {
    ...
    fun chatSettingList() = listOf(
        app.interview.ale.beer.base.preference.AppSettings.AICHAT_AUTO_SEND_AFTER_VOICE,
        app.interview.ale.beer.base.preference.AppSettings.AICHAT_MEMORY_ABILITY
    )
}