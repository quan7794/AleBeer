package app.wac.team.wacbase.base.viewmodel

import android.content.res.Resources
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import app.wac.team.wacbase.R
import app.wac.team.wacbase.domain.Failure
...
open class BaseViewModel @Inject constructor() : ViewModel(),
    ...
    fun handleFailure(throwable: Throwable, retryAction: () -> Unit) {
        val failure = when (throwable) {
            is Failure.NoInternet -> { Failure.NoInternet(resources.getString(R.string.error_no_internet)) }
